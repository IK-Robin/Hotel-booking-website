...
<body class="bg-light">
  ...
  $res = select("SELECT * FROM `rooms` WHERE `id`=? AND  `status`=? AND `remove`=?", [$rooms_id['id'], 1, 0], 'iii');
      ...
      <div class="col-lg-5 col-md-12 mt-5">
        ...
        <div class="card mb-3 border-0 shadow">
          <div class="card-body">
            ...
            <div class="book-now ">
              <a  href="books_room.php?room_id=<?php echo $room['id']; ?> &checkout&checkin=" class="btn btn-primary w-100">Book Now</a>
            </div>
          </div>
